...
import { StyleSheet, TextInput, View, Text, TouchableOpacity, Image, TouchableWithoutFeedback, I18nManager } from "react-native";
  ...
  return (
    ...
    <View>
      <Row style={{ width: '100%' }}>
        ...
        />
        {props.toggleEye && (
          <TouchableOpacity onPress={() => setIsSecure(state => state = !isSecure)}>
            <Image 
              source={EyeImg}
              style={[styles.eyeImg,{ opacity: isSecure ? 1 : .3 }]}
            />
          </TouchableOpacity>
        )}
      </Row>
      ...
      <View
        style={[
          styles.bottomLine,
          { backgroundColor: focused ? "#BF4C58" : '#ECE7E9', height: focused ? 2 : 1 },
          validated !== null && validated && { backgroundColor: 'green' },
          validated !== null && validated === false && { backgroundColor: '#BF4C58' },
        ]}
      />
    </View>
    </TouchableWithoutFeedback>
