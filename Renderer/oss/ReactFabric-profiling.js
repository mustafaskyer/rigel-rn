...
function areHookInputsEqual(arr1, arr2) {
  for (var i = 0; i < arr1.length; i++) if (!is(arr1[i], arr2[i])) return !1;
  return !0;
}
...
function constructClassInstance(workInProgress, ctor, props) {
  ...
  "object" === typeof context && null !== context
    ? (context = ReactCurrentDispatcher$1.current.readContext(context))
...
function mountClassInstance(
  ...
  "object" === typeof contextType && null !== contextType
    ? (instance.context = ReactCurrentDispatcher$1.current.readContext(
        contextType
      ))
...
function updateClassComponent(
  ...
  if (null === workInProgress.stateNode)
    ...
    "object" === typeof contextType && null !== contextType
      ? (contextType = ReactCurrentDispatcher$1.current.readContext(
          contextType
        ))
    ...
    case 10:
      a: {
        ...
        if (null !== getDerivedStateFromProps) {
          ...
          context = is(oldValue, context)
            ? 0
            : ("function" === typeof updateExpirationTime._calculateChangedBits
                ? updateExpirationTime._calculateChangedBits(oldValue, context)
                : 1073741823) | 0;
          if (0 === context) {
            if (
  ...
  if (
    ...
    do {
      ...
      if (current$$1) {
        ...
        null === returnFiber
          ? (value.updateQueue = new Set([thenable]))
...
function renderRoot(root, isYieldy) {
  ...
  isWorking = !1;
  lastContextWithAllBitsObserved = lastContextDependency = currentlyRenderingFiber = ReactCurrentDispatcher.current = null;
  resetHooks();
